...

{
  flake.homeModules.scroll =
    ...
    let
      ...
      # Converts a transform in degrees to Scroll's transform index (90° increments)
      scrollTransform = deg: deg / 90;
      ...
      startupAppsScript = pkgs.writers.writeLua "scroll_startup_apps.lua" { } ''
        local scroll = require("scroll")
        ...
        local function on_focus_ws(workspace, _)
          ...
          -- Only start when primary (landscape) output is focused and ready
          if width and height and width > height then
            started = true
            ${lib.concatMapStringsSep "\n      " (
              app: "scroll.command(nil, \"exec ${app}\")"
