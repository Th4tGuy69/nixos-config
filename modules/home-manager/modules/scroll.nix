      ...
      home = {
        file.".config/scroll/config".text = ''
          ...
          mode "trail" {
              ...
              bindsym Shift+1 trail save 1; mode default
              bindsym Shift+2 trail save 2; mode default
              bindsym Shift+3 trail save 3; mode default
              bindsym Shift+4 trail save 4; mode default
              bindsym Shift+5 trail save 5; mode default
              bindsym Shift+6 trail save 6; mode default
              bindsym Shift+7 trail save 7; mode default
              bindsym Shift+8 trail save 8; mode default
              bindsym Shift+9 trail save 9; mode default
              bindsym Shift+0 trail save 0; mode default
              bindsym Ctrl+1 trail restore 1; mode default
              bindsym Ctrl+2 trail restore 2; mode default
              bindsym Ctrl+3 trail restore 3; mode default
              bindsym Ctrl+4 trail restore 4; mode default
              bindsym Ctrl+5 trail restore 5; mode default
              bindsym Ctrl+6 trail restore 6; mode default
              bindsym Ctrl+7 trail restore 7; mode default
              bindsym Ctrl+8 trail restore 8; mode default
              bindsym Ctrl+9 trail restore 9; mode default
              bindsym Ctrl+0 trail restore 0; mode default
              bindsym Escape mode "default"
          }
